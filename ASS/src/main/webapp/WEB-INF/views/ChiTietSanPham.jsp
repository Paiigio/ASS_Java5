    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="container ">
                ...
                <form:form action="/chi-tiet-san-pham/add" modelAttribute="sv">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="col-md-4">
                                <h5>Sản phẩm</h5>
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="c" varStatus="stt">
                        <tr>
                            ...
                            <th scope="row">${c.sanPham.ten}</th>
                            <th scope="row">${c.nsx.ten}</th>
                            <th scope="row">${c.mauSac.ten}</th>
                            <th scope="row">${c.dongSP.ten}</th>
                            <th scope="row">${c.namBh}</th>
                            <th scope="row">${c.moTa}</th>
                            <th scope="row">${c.soLuongTon}</th>
                            <th scope="row">${c.giaBan}</th>
                            <th scope="row">${c.giaNhap}</th>
                            <th>
                                <a href="/chi-tiet-san-pham/detail/${c.id}" class="btn btn-success">Detail</a><br>
                                <a href="/chi-tiet-san-pham/view-update/${c.id}" class="btn btn-success">Update</a><br>
                                <a href="/chi-tiet-san-pham/delete/${c.id}" class="btn btn-danger mt-3">Delete</a>
