    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="container ">
                ...
                <form:form action="/san-pham/add" modelAttribute="sv">
                    <div class="row">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="c">
                        <tr>
                            ...
                            <th>
                                <a href="/san-pham/detail/${c.id}" class="btn btn-success">Detail</a>
                                <a href="/san-pham/view-update/${c.id}" class="btn btn-success">Update</a>
                                <a href="/san-pham/delete/${c.id}" class="btn btn-danger">Delete</a>
                            </th>
