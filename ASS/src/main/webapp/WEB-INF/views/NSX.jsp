    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="container ">
                ...
                <form:form action="/nsx/add" modelAttribute="sv">
                    <div class="row">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="c">
                        <tr>
                            ...
                            <th>
                                <a href="/nsx/detail/${c.id}" class="btn btn-success">Detail</a>
                                <a href="/nsx/view-update/${c.id}" class="btn btn-success">Update</a>
                                <a href="/nsx/delete/${c.id}" class="btn btn-danger">Delete</a>
                            </th>
