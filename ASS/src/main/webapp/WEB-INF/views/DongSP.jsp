    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="container ">
                ...
                <form:form action="/dongSP/add" modelAttribute="sv">
                    <div class="row">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="c">
                        <tr>
                            ...
                            <th>
                                <a href="/dongSP/detail/${c.id}" class="btn btn-success">Detail</a>
                                <a href="/dongSP/view-update/${c.id}" class="btn btn-success">Update</a>
                                <a href="/dongSP/delete/${c.id}" class="btn btn-danger">Delete</a>
                            </th>
