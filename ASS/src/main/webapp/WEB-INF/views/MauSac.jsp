    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="container ">
                ...
                <form:form action="/mau-sac/add" modelAttribute="sv">
                    <div class="row">
                        <div>
                            <div class="col-md-6">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="c">
                        <tr>
                            ...
                            <th>
                                <a href="/mau-sac/detail/${c.id}" class="btn btn-success">Detail</a>
                                <a href="/mau-sac/view-update/${c.id}" class="btn btn-success">Update</a>
                                <a href="/mau-sac/delete/${c.id}" class="btn btn-danger">Delete</a>
